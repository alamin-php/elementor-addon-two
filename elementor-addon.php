...
final class Elementor_Addon_Halim_Extension {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Addon Halim Extension', 'elementor-addon-halim' ) . '</strong>',
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Addon Extension', 'elementor-addon-halim' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'elementor-addon-halim' ) . '</strong>',
	...
	public function widget_styles() {
		wp_register_style( 'elementor-addon-halim-style', plugins_url( 'style.css', __FILE__ ) );
		wp_enqueue_style('elementor-addon-halim-style');
	}	

    // Custom JS
	public function widget_scripts() {
		wp_register_script( 'elementor-addon-halim-js', plugins_url( 'main.js', __FILE__ ) );
		wp_enqueue_script('elementor-addon-halim-js');
	}
    ...
    public function elementor_addon_halim_category () {
	   ...
	   \Elementor\Plugin::$instance->elements_manager->add_category( 
	   	'elementor_addon_halim_category',
	   	[
